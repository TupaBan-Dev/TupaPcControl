...
main_menu_1 = InlineKeyboardMarkup()
...
main_menu_1.add(main_menu_button_3, main_menu_button_4)
main_menu_1.add(main_menu_button_5, main_menu_button_6)
main_menu_1.add(main_menu_button_7, main_menu_button_8)

main_menu_2 = InlineKeyboardMarkup()
...
main_menu_2.add(main_menu_button_3, main_menu_button_4)
main_menu_2.add(main_menu_button_5, main_menu_button_6)
main_menu_2.add(main_menu_button_7, main_menu_button_8)

main_menu_3 = InlineKeyboardMarkup()
...
main_menu_button_3 = InlineKeyboardButton(text="◀️", callback_data="menu_back_2")
main_menu_button_4 = InlineKeyboardButton(text="▶", callback_data="menu_next_3")
main_menu_3.add(main_menu_button_1, main_menu_button_2)
main_menu_3.add(main_menu_button_3, main_menu_button_4)
